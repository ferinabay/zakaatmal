        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card card-default">
                    <div class="card-header">tugas framwork laravel</div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive mt-2">
                            <table class="table table-hover table-bordered">
                                ...
                                <tr v-for="(me, index) in user" :key="me.id">
                                    ...
                                    //     <router-link :to="{name: 'edit', params: { id: login.id }}" class="btn btn-sm btn-primary">EDIT</router-link>
                                    //     <button @click.prevent="PostDelete(login.id, index)" class="btn btn-sm btn-danger">HAPUS</button>
                                    // </td>
                                </tr>
                                </tbody>
                            </table>
